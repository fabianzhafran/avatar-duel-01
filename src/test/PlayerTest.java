...
public class PlayerTest {
    ...
    public void testPutToField() {
        ...
        assertEquals("there is 1 monster on field", 1, dummy.getNumberMonsterOnField());
    ...
    public void testRemoveMonsterOnField() {
        ...
        assertEquals("must be no monster on field", 0, dummy.getNumberMonsterOnField());
    ...
    public void testRemoveSkillOnField(){
        ...
        assertEquals("there is 1 skill on field",1,dummy.getNumberSkillOnField());

        dummy.removeSkillOnField(0);

        assertEquals("must be no monster on field",0,dummy.getNumberSkillOnField());
    }
    ...
    public void testAttack() {
        ...
        SummonedMonster enemyMonster = (dummyEnemy.getMonsterOnField())[0];
    ...
    public void testAura() {
        ...
        int j = 0;
        handGet = hand.get(j);
        while (!((Aura)((Skill)handGet)).getType().equals("Aura")) {
            j++;
            handGet = hand.get(j);

        }

        Aura cardAura = handGet;
    ...
    public void testDestroy() {
        ...
        while (!((Destroy)((Skill)handGet)).getType().equals("Destroy")) {
            j++;
            handGet = hand.get(j);
        }
        ...
        assertEquals("monster musuh ada 0", 0, dummyEnemy.getNumberMonsterOnField());
    ...
    public void testPowerUp() {
        ...
        int j = 0;
        handGet = hand.get(j);
        while (!((Aura)((Skill)handGet)).getType().equals("Power Up")) {
            j++;
            handGet = hand.get(j);
        ...
        assertEquals("piercing harusnya aktif", true, monster.getPiercing());
